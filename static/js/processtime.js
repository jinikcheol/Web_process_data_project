      ...
      for (l = 0; l < h.length; l++) {
        ...
        if (q > g)
          var B = g,
            ...
            q = B;
        if (n.scaleBreaks)
          for (B = 0; !f && B < n.scaleBreaks._appliedBreaks.length; B++)
            f =
              n.scaleBreaks._appliedBreaks[B].startValue <= q &&
              n.scaleBreaks._appliedBreaks[B].endValue >= g;
          ...
          if (
            ...
            !(
              ...
              (!(
                ...
                ((n.logarithmic && B < Math.pow(n.dataInfo.minDiff, 3)) ||
                  (!n.logarithmic && B < 3 * Math.abs(n.dataInfo.minDiff)))) ||
              q < n.minimum ||
              g > n.maximum
            ))
          )
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        ...
        if (null !== A && "" !== A) {
          ...
          if ("stackedarea100" === p) {
            ...
            if (
              h.dataPoint.x < C.viewportMinimum ||
              h.dataPoint.x > C.viewportMaximum ||
                ...
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ...
                    : (Math.max(h.bounds.y1, c.y1) +
                      ...
                      2),
                0 < J
                  ? ((q = Math.max(h.point.y, b) - z / 2),
                    q < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (q = Math.max(h.point.y - z - l, c.y1 + l)))
                  : ((q = Math.min(h.point.y, b) - z / 2),
                    q > f - z - l &&
                      ("bubble" === p || "scatter" === p) &&
          ...
          m &&
            ...
            0 <= p.indexOf("bar") || ("error" === p && h.axisSwapped)
              ...
              : d.lineTo(
                  n + u / 2,
                  q +
                    ((q < h.point.y ? z : -z) + ("horizontal" === x ? z : -z)) /
                      2
                ),
            d.stroke());
        }
                  ...
                  t < p.length - 1 &&
                    ...
                    c.setLineDash &&
                      (p[t].lineDashType
                        ...
                        : ((n = h.lineDashType), c.setLineDash(g))));
                  if (0 < p[t].markerSize || 0 < h.markerSize)
                    (C = h.getMarkerProperties(t, x, r, c)),
                      f.push(C),
                      (y = S(y)),
                      s &&
                        f.push({
        ...
        for (p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < B.length)
            for (
              ...
              if (
                (B[f].getTime ? (z = B[f].x.getTime()) : (z = B[f].x),
                !(
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (z[b] = t[h].y + (z[b] ? z[b] : 0)),
                    (C = a.axisY.convertValueToPixel(z[b])),
            ...
            for (h = 0; h < t.length; h++)
              if (
                ...
                if (
                  ...
                  (z[b] = A + (z[b] ? z[b] : 0)),
                    (p = l[b] ? l[b] : q),
                    (l[b] = A = a.axisY.convertValueToPixel(z[b]));
        ...
        for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < B.length) {
            ...
            for (var ha = !0; k < B.length; k++)
              if (
                ((r = B[k].x.getTime ? B[k].x.getTime() : B[k].x),
                !(
                ...
                if ("number" !== typeof B[k].y)
                  ...
                  k < B.length - 1 &&
                    (w !== (B[k].lineColor || v) ||
                      c !== (B[k].lineDashType || g.lineDashType)) &&
                    (b(),
                    (w = B[k].lineColor || v),
                    (f.strokeStyle = w),
                    f.setLineDash &&
              ...
              if (
                ...
                "number" !== typeof B[k].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(r)),
                    ...
                    k < B.length - 1 &&
                      (w !== (B[k].lineColor || v) ||
                        K !== (B[k].lineDashType || g.lineDashType)) &&
                      (b(),
                      (w = B[k].lineColor || v),
                      (f.strokeStyle = w),
                      f.setLineDash &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], J = 0; J < a.dataSeriesIndexes.length; J++) {
          ...
          for (q = 0; q < v.length; q++)
            (C = v[q].x.getTime ? v[q].x.getTime() : v[q].x),
              (y.dataPointIndexes[C] = q),
              e[C] || (p.push(C), (e[C] = !0));
          p.sort(Pa);
        }
            ...
            for (var $ = !0, q = 0; q < p.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  q < v.length - 1 &&
                    (K !== (v[q].lineColor || w) ||
                      A !== (v[q].lineDashType || y.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, k),
                    h.push({ x: g, y: m - na }),
                    ...
                    b.setLineDash &&
                      (v[q].lineDashType
                        ? ((A = v[q].lineDashType),
                          b.setLineDash(Q(A, y.lineThickness)))
                        : ((A = y.lineDashType), b.setLineDash(D))));
    ...
    m.prototype.renderCandlestick = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
          ...
          if (0 < x.length)
            for (
              var A = 5 < m && t.bevelEnabled ? !0 : !1, u = 0;
              u < x.length;
              u++
            )
              if (
    ...
    m.prototype.renderPie = function (a) {
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < p.length) {
          ...
          l =
            "right" === m.hemisphere
              ? A.x + Math.sqrt(Math.pow(s, 2) - Math.pow(c - A.y, 2))
              : A.x - Math.sqrt(Math.pow(s, 2) - Math.pow(c - A.y, 2));
          ...
          h &&
            ...
            (c =
              "right" === m.hemisphere
                ? A.x + Math.sqrt(Math.pow(s, 2) - Math.pow(d - A.y, 2))
                : A.x - Math.sqrt(Math.pow(s, 2) - Math.pow(d - A.y, 2))),
            ...
            (m.indexLabelAngle = Math.atan2(
              m.indexLabelTextBlock.y - A.y,
              m.indexLabelTextBlock.x - A.x
            )));
        }
        return h;
      }
          ...
          if ("inside" !== h.indexLabelPlacement) {
            ...
            for (a = 0; a < p.length; a++)
              (k = g[a]),
                ...
                (r = A.x + s * Math.cos(k.midAngle)),
                (t = A.y + s * Math.sin(k.midAngle)),
                  ...
                  (!l &&
                    ...
                    ((t =
                      0 < k.indexLabelAngle && k.indexLabelAngle < Math.PI
                        ...
                        : 1),
                    0 === f(a, r * t) && f(a, 2 * t)),
                  Math.abs(k.indexLabelTextBlock.x - A.x) < y &&
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var C = 0; C < p.length; C++)
          (w += Math.abs(p[C].y)),
            !a &&
              "undefined" !== typeof p[C].indexLabel &&
              null !== p[C].indexLabel &&
              0 < p[C].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof p[C].label &&
              null !== p[C].label &&
              0 < p[C].label.toString().length &&
              (a = !0);
        if (0 !== w) {
          a =
            a ||
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var t = this.data[a.dataSeriesIndexes[0]],
            ...
            y = 0,
            E = A.height - 2 * D,
            G = Math.min(A.width - 2 * C, 2.8 * A.height),
            K = !1,
            P = 0;
          P < x.length;
          P++
          ...
          if (-1 !== P) {
            ...
            if (t.reversed)
              for (F = 0; F < P.length; F++)
                G[F] < xa
                  ? (a.push(M), C.push(Y), (da = F))
                  : (a.push((G[F] - U + ba * X) / ba),
                    C.push((G[F] - U + fa * aa) / fa));
            else
              for (F = 0; F < P.length; F++)
                G[F] < xa
                  ? (a.push((G[F] - U + ba * X) / ba),
          ...
          if (
            ...
            var q = (n.legendMarkerType = n.legendMarkerType
              ...
              g = n.legendText
                ...
                : n.name,
              B = (n.legendMarkerColor = n.legendMarkerColor
                ? n.legendMarkerColor
                : n.markerColor
                ? n.markerColor
                : "error" === n.type
    ...
    D.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            var B = q[g].scaleBreaks._appliedBreaks, s = 0;
            s < B.length && !(B[s].startValue > q[g].viewportMaximum);
            s++
          )
            B[s].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) &&
                (q[g].scaleBreaks.firstBreakIndex = s),
              B[s].startValue >= q[g].viewPortMinimum &&
